...
export const DocumentDeadLine = ({ isOpen, onClose }: any) => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    const document_deadline_time = `${day}:${hours}:${minutes}:${seconds}`;
    setValue('document_deadline_time', document_deadline_time);
    onClose();
  };
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      ...
      <DialogContent className='fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-white rounded-lg shadow-xl w-full max-w-md p-6 animate-scaleIn'>
