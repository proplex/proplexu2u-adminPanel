      ...
      <div className="p-6 space-y-4">
        ...
        <Tabs defaultValue="awaiting" >
          <TabsList className='w-full bg-gray-100 flex items-start h-auto justify-start p-3 gap-4'>
            ...
            <TabsTrigger value="hold" className="data-[state=active]:bg-purple-500 data-[state=active]:text-white data-[state=inactive]:bg-white p-2">Hold</TabsTrigger>
...
export default ChannelAssetsPartner
